    ...
    <div class="mt-6 md:mt-0 text-center md:text-left flex-1">
      ...
      <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 max-w-md mx-auto md:mx-0">
        <div>
          ...
          <dd class="mt-1 text-gray-900"><?= $user['no_telp'] ?? '-'; ?></dd>
        </div>
        <div>
          <dt class="font-medium text-gray-700">Status</dt>
          <dd class="mt-1 text-gray-900"><?= $user['status'] ?? '-'; ?></dd>
        </div>
        <div>
          <dt class="font-medium text-gray-700">Tanggal Lahir</dt>
          <dd class="mt-1 text-gray-900"><?= date('d F Y', strtotime($user['tanggal_lahir'] ?? '0000-00-00')); ?></dd>
        </div>
        <div>
          <dt class="font-medium text-gray-700">Member Sejak</dt>
          <dd class="mt-1 text-gray-900"><?= date('F Y', strtotime($user['created_at'] ?? '0000-00-00')); ?></dd>
        </div>
      </div>
      <div class="mt-4 flex justify-center md:justify-start space-x-4">
        <a href="<?= base_url('akun/edit_profil'); ?>" class="text-blue-600 hover:text-blue-800 font-semibold">Edit Profile</a>
